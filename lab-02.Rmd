...
author: "Team Name: Ledger, Charlie, John, David"
date: "`r Sys.Date()`"
...
plastic_data_all %>% 
  ...
  group_by(region) %>% 
  summarise(mean_total_mismanaged=mean(total_mismanaged_plastic,na.rm=T),count=n(),
            total_mismanaged_plastic=sum(total_mismanaged_plastic,na.rm=T)) %>% 
  arrange(desc(total_mismanaged_plastic))
